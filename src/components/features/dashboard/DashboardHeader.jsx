...
import AdaptiveGlass from '../../common/AdaptiveGlass';
            ...
            <Grid container spacing={3} alignItems="stretch">
                <Grid size={{ xs: 12, md: 5 }}>
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} style={{ height: '100%' }}>
                        <AdaptiveGlass hoverEffect intensity="medium" sx={{ height: '100%', p: 3 }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                                <Box>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                                        <Avatar sx={{ bgcolor: 'primary.main', width: 48, height: 48, boxShadow: '0 4px 12px rgba(94, 92, 230, 0.4)' }}>
                ...
                <Grid size={{ xs: 12, md: 7 }}>
                    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} style={{ height: '100%' }}>
                        <AdaptiveGlass hoverEffect intensity="high" sx={{ height: '100%', p: 3, position: 'relative', overflow: 'hidden' }}>
