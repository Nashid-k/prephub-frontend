...
const SystemDesignPage = () => {
    ...
    // System Design slugs to include
    const targetSlugs = [
        'system-design',
        'api-design',
    ...
    const fetchTopics = async () => {
        try {
            ...
            setError('Failed to load System Design topics.');
        } finally {
            setLoading(false);
        }
    };
            ...
            <Container maxWidth="xl">
                ...
                >
                    <Box sx={{ mb: 6, textAlign: 'center' }}>
                        ...
                        >
                            <Architecture sx={{ fontSize: 40, color: 'white' }} />
                        </Box>
                        <Typography
                            variant="h3"
                            sx={{
                        ...
                        <Typography variant="h6" sx={{ opacity: 0.7, fontWeight: 400, mb: 3 }}>
                            Master scalable architecture and distributed systems
                        </Typography>
                    </Box>
                </motion.div>
