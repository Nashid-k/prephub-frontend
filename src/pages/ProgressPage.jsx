...
const ProgressPage = () => {
    ...
    const getTopicImage = (topicSlug) => {
        ...
        console.log('Topic slug:', topicSlug, '-> normalized:', normalizedSlug);
        ...
        const imageMap = {
            ...
            'js': '/images/topics/javascript.png',
            'typescript': '/images/topics/typescript.png',
            'ts': '/images/topics/typescript.png',
            'postgresql': '/images/topics/postgresql.svg',
            'postgres': '/images/topics/postgresql.svg',
            'psql': '/images/topics/postgresql.svg',
        };

        const imagePath = imageMap[normalizedSlug];
        console.log('Image path for', normalizedSlug, ':', imagePath);

        return imagePath || '/images/topics/dsa.svg';
    };
