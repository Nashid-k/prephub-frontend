            ...
            <Box sx={{
                background: (theme) =>
                    theme.palette.mode === 'dark'
                        ? `radial-gradient(circle at top right, ${topicColor}15 0%, ${theme.palette.background.default} 100%)`
                        : `radial-gradient(circle at top right, ${topicColor}08 0%, ${theme.palette.background.default} 100%)`,
                pt: { xs: 12, md: 16 },
                pb: { xs: 6, md: 8 },
                position: 'relative',
                overflow: 'hidden',
                ...
                <Container maxWidth="xl" sx={{ px: { xs: 2, md: 3 } }}>
                    ...
                    {/* Sections List - Inside Container */}
                    <Box>
